    ...
    <div class="col-12">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form action="<?= base_url('room/update/' . $room['id']) ?>" method="post">
                    <?= csrf_field() ?>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="room_no" name="room_no" value="<?= old('room_no') ?? $room['room_no'] ?>" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="no_of_bed" name="no_of_bed" value="<?= old('no_of_bed') ?? $room['no_of_bed'] ?>" min="1" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" id="cost_per_bed" name="cost_per_bed" value="<?= old('cost_per_bed') ?? $room['cost_per_bed'] ?>" min="0" step="0.01" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input" id="active" name="active" value="1" <?= (old('active') ?? $room['active']) == '1' ? 'checked' : '' ?>>
