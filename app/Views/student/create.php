...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted">Enter student information and enrollment details</p>
        </div>
        <div>
    ...
    <!-- Student Form -->
    <form action="<?= base_url('students/store') ?>" method="post" enctype="multipart/form-data" id="studentForm">
        <?= csrf_field() ?>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control <?= isset($validation) && $validation->hasError('admission_no') ? 'is-invalid' : '' ?>" 
                                       name="admission_no" value="<?= old('admission_no') ?>" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="adhar_no" value="<?= old('adhar_no') ?>" maxlength="12">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="tel" class="form-control <?= isset($validation) && $validation->hasError('mobileno') ? 'is-invalid' : '' ?>" 
                                       name="mobileno" value="<?= old('mobileno') ?>" required>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" name="current_address" rows="3"><?= old('current_address') ?></textarea>
                            </div>
                            <div class="col-md-12">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="guardian_relation" value="<?= old('guardian_relation') ?>">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Guardian Phone</label>
                                <input type="tel" class="form-control" name="guardian_phone" value="<?= old('guardian_phone') ?>">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" name="guardian_address" rows="3"><?= old('guardian_address') ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control" name="height" value="<?= old('height') ?>" step="0.1">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Weight (kg)</label>
                                <input type="number" class="form-control" name="weight" value="<?= old('weight') ?>" step="0.1">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Measurement Date</label>
                                <input type="date" class="form-control" name="measurement_date" value="<?= old('measurement_date') ?>">
                            </div>
                        </div>
                    </div>
                </div>
